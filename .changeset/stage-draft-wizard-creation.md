...
- Seeds the fixed `OrganismStructureType` label list used by the inline-organism-creation dropdown: Secteur Médico-social, Sanitaire, Fédéral, Libéral and Associatif (the dev seed removes any other label left over from an earlier list).
