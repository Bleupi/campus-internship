...
model User {
  ...
  email        String   @unique          // login email; for students this is the immutable u-paris email
  passwordHash String
  firstName    String
  lastName     String
...
model StudentProfile {
  ...
  phone         String?
  personalEmail String?                     // mutable, unlike the login (u-paris) email; must not itself be a u-paris.fr address (STUDENT_EMAIL_DOMAIN)
